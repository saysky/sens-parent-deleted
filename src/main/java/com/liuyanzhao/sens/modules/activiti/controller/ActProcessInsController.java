...
import com.liuyanzhao.sens.config.activiti.ActivitiExtendProperties;
...
import com.liuyanzhao.sens.modules.activiti.vo.ActPage;
import com.liuyanzhao.sens.modules.activiti.vo.HistoricProcessInsVo;
import com.liuyanzhao.sens.modules.activiti.vo.ProcessInsVo;
...
@RequestMapping("/sens/actProcess")
@Transactional
public class ActProcessInsController {
    ...
    public void getHighlightImg(@ApiParam("流程实例id") @PathVariable String id,
        ...
        try {
            ...
            throw new SensException("读取流程图片失败");
        }
    }
