...
import com.liuyanzhao.sens.modules.base.vo.GithubUserInfo;
...
import com.liuyanzhao.sens.modules.base.service.GithubService;
...
@RequestMapping("/sens/social/github")
@Controller
public class GithubController {

    @Value("${sens.social.github.clientId}")
    private String clientId;

    @Value("${sens.social.github.clientSecret}")
    private String clientSecret;

    @Value("${sens.social.github.callbackUrl}")
