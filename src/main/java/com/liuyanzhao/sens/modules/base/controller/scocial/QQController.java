...
import com.liuyanzhao.sens.modules.base.vo.QQUserInfo;
import com.liuyanzhao.sens.common.vo.Result;
import com.liuyanzhao.sens.modules.base.entity.social.QQ;
import com.liuyanzhao.sens.modules.base.service.QQService;
...
@RequestMapping("/sens/social/qq")
@Controller
public class QQController {

    @Value("${sens.social.qq.appId}")
    private String appId;

    @Value("${sens.social.qq.appKey}")
    private String appKey;

    @Value("${sens.social.qq.callbackUrl}")
