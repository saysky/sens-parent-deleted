package com.liuyanzhao.sens.modules.base.controller.scocial;

import com.liuyanzhao.sens.common.constant.CommonConstant;
import com.liuyanzhao.sens.common.constant.SecurityConstant;
import com.liuyanzhao.sens.common.utils.ResultUtil;
import com.liuyanzhao.sens.common.utils.SecurityUtil;
import com.liuyanzhao.sens.modules.base.vo.AccessToken;
import com.liuyanzhao.sens.common.vo.Result;
import com.liuyanzhao.sens.modules.base.vo.WeiboUserInfo;
import com.liuyanzhao.sens.modules.base.entity.social.Weibo;
import com.liuyanzhao.sens.modules.base.service.WeiboService;
...
@RequestMapping("/sens/social/weibo")
@Controller
public class WeiboController {

    @Value("${sens.social.weibo.appKey}")
    private String appKey;

    @Value("${sens.social.weibo.appSecret}")
    private String appSecret;

    @Value("${sens.social.weibo.callbackUrl}")
    private String callbackUrl;

    @Value("${sens.social.callbackFeUrl}")
    private String callbackFeUrl;

    @Value("${sens.social.callbackFeRelateUrl}")
