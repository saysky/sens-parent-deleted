...
import com.liuyanzhao.sens.common.vo.EsCount;
import com.liuyanzhao.sens.common.vo.EsInfo;
...
@RequestMapping("/sens/es")
@Transactional
public class EsController {

    @Value("${sens.elasticsearch.nodeClient}")
    ...
    public Result<EsInfo> getAllByPage(){
        ...
        if(StrUtil.isBlank(healthResult)||StrUtil.isBlank(countResult)){
            throw new SensException("连接ES失败，请检查ES运行状态");
        }
        ...
        try {
            ...
            e.printStackTrace();
            throw new SensException("获取ES信息出错");
        }
