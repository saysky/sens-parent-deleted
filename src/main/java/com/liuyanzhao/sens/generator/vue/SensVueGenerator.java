package com.liuyanzhao.sens.generator.vue;
...
import com.liuyanzhao.sens.generator.bean.Field;
...
@RequestMapping(value = "/sens/generate")
public class SensVueGenerator {
    ...
    public String generate(String template, String vueName, Integer rowNum, List<Field> fields) throws IOException {
        ...
        // 模板路径
        String root = System.getProperty("user.dir")+"/src/main/java/com/liuyanzhao/sens/generator/vue";
        ...
        if(rowNum==1){
            ...
            throw new SensException("rowNum仅支持数字1-4");
        }
        // 生成代码
