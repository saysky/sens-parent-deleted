package com.liuyanzhao.sens.config.security.jwt;
...
import com.liuyanzhao.sens.common.utils.ResponseUtil;
import com.liuyanzhao.sens.common.vo.TokenUser;
...
public class AuthenticationSuccessHandler extends SavedRequestAwareAuthenticationSuccessHandler {
    ...
    @Value("${sens.token.redis}")
    private Boolean tokenRedis;

    @Value("${sens.tokenExpireTime}")
    private Integer tokenExpireTime;

    @Value("${sens.saveLoginTime}")
    private Integer saveLoginTime;

    @Value("${sens.token.storePerms}")
