package com.liuyanzhao.sens.generator;

import com.liuyanzhao.sens.generator.bean.Entity;
...
public class SensMPGenerator {
     ...
     * 建议仅需修改
     */
    private static final String author = "言曌";
     ...
     * (文件自动生成至该包下)
     */
    private static final String entityPackage = "com.liuyanzhao.sens.modules.your.entity";

    /**
     * dao对应包
     * (文件自动生成至该包下)
     */
    private static final String daoPackage = "com.liuyanzhao.sens.modules.your.dao.mapper";

    /**
     * service对应包
     * (文件自动生成至该包下)
     */
    private static final String servicePackage = "com.liuyanzhao.sens.modules.your.service";

    /**
     * serviceImpl对应包
     * (文件自动生成至该包下)
     */
    private static final String serviceImplPackage = "com.liuyanzhao.sens.modules.your.serviceimpl";

    /**
     * controller对应包
     * (文件自动生成至该包下)
     */
    private static final String controllerPackage = "com.liuyanzhao.sens.modules.your.controller";
    ...
    public static void main(String[] args) throws IOException {
        ...
        //模板路径
        String root = System.getProperty("user.dir")+"/src/main/java/com/liuyanzhao/sens/generator/template";
    ...
    private static void generateCode(GroupTemplate gt) throws IOException{
        ...
        entity.setTableName(tablePre+ SensGenerator.camel2Underline(className));
        entity.setClassNameLowerCase(SensGenerator.first2LowerCase(className));
        ...
        //创建文件
        String entityFileUrl = System.getProperty("user.dir")+"/src/main/java/"+ SensGenerator.dotToLine(entityPackage) + "/" + className + ".java";
        ...
        log.info(daoResult);
        //创建文件
        String daoFileUrl = System.getProperty("user.dir")+"/src/main/java/"+ SensGenerator.dotToLine(daoPackage) + "/" +className + "Mapper.java";
        ...
        //创建文件
        String serviceFileUrl = System.getProperty("user.dir")+"/src/main/java/"+ SensGenerator.dotToLine(servicePackage) + "/I" + className + "Service.java";
        ...
        //创建文件
        String serviceImplFileUrl = System.getProperty("user.dir")+"/src/main/java/"+ SensGenerator.dotToLine(serviceImplPackage) + "/I" + className + "ServiceImpl.java";
        ...
        //创建文件
        String controllerFileUrl = System.getProperty("user.dir")+"/src/main/java/"+ SensGenerator.dotToLine(controllerPackage) + "/" + className + "Controller.java";
